                ...
                if(tiket[update.chatId].state=="none"):
                    ...
                    if(tiket[update.chatId].noTiket!=''):
                        if "/input_keterangan" in update.konten[0]:
                            ...
                            send_message(update.chatId,"Silahkan input lokasi")
                        ...
                        send_message(update.chatId,"Silahkan masukkan nomor tiket terlebih dahulu")
                else:
                    if(tiket[update.chatId].state=="notiket"):
                        if(update.tipeKonten=="text"):
                            tiket[update.chatId].setNoTiket(update.konten[0])
                            send_message(update.chatId,"Nomor Tiket: "+tiket[update.chatId].noTiket+" berhasil diinput")
                        ...
                        if(update.tipeKonten=="text"):
                            ...
                            send_message(update.chatId,"Keterangan berhasil terinput")
                            tiket[update.chatId].setState("none")
                        else:
                        ...
                        if(update.tipeKonten=="location"):
                            ...
                            send_message(update.chatId,"Input gambar harus berupa lokasi")
                try:
